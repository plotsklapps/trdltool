...
Future<void> showGeneralCallSheet({
  ...
  Future<void> handleGeneralAreaPressed(String area) async {
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: PhoneButton(
                      ...
                      onPressed: () async {
                        await handleGeneralAreaPressed('NOORD');
                      },
                ...
                children: <Widget>[
                  Expanded(
                    child: PhoneButton(
                      ...
                      databaseService: DatabaseService(),
                      onPressed: () async {
                        await handleGeneralAreaPressed('WEST');
                      },
                      buttonColor: Theme.of(context).colorScheme.onPrimary,
                      labelColor: Theme.of(context).colorScheme.primary,
                      progressIndicatorColor: Theme.of(
                  ...
                  Expanded(
                    child: PhoneButton(
                      ...
                      databaseService: DatabaseService(),
                      onPressed: () async {
                        await handleGeneralAreaPressed('CENTRUM');
                      },
                      buttonColor: Theme.of(context).colorScheme.onPrimary,
                      labelColor: Theme.of(context).colorScheme.primary,
                      progressIndicatorColor: Theme.of(
                  ...
                  Expanded(
                    child: PhoneButton(
                      ...
                      databaseService: DatabaseService(),
                      onPressed: () async {
                        await handleGeneralAreaPressed('OOST');
                      },
                      buttonColor: Theme.of(context).colorScheme.onPrimary,
                      labelColor: Theme.of(context).colorScheme.primary,
                      progressIndicatorColor: Theme.of(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: PhoneButton(
                      ...
                      databaseService: DatabaseService(),
                      onPressed: () async {
                        await handleGeneralAreaPressed('ZUID');
                      },
                      buttonColor: Theme.of(context).colorScheme.onPrimary,
                      labelColor: Theme.of(context).colorScheme.primary,
                      progressIndicatorColor: Theme.of(
